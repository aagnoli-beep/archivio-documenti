...
var DEFAULT_CONFIG = [
  ...
  ['LONG_PDF_PAGES', '30', 'Sopra questo numero di pagine il PDF viene classificato leggendo il testo invece del PDF intero (costa molto meno)'],
...
function getConfig() {
  ...
  return {
    ...
    longPdfPages: parseInt(kv.LONG_PDF_PAGES, 10) || 30,
